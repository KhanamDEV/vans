...
class Paginator{
    ...
    public function page_links($path='?',$ext=null)
    {
        ...
        if($lastpage > 1)
        {
            $pagination .= "<nav aria-label='Page navigation example'> <ul class='pagination justify-content-center ".$this->_customCSS."'>";
            if ($this->_page > 1)
                $pagination.= "<li class='page-item'><a  class='page-link' href='".$path."$this->_instance=$prev"."$ext'><i class='fa fa-long-arrow-left' aria-hidden='true'></i></a></li>";
            else
                $pagination.= "<span class='disabled'><i class='fa fa-long-arrow-left' aria-hidden='true'></i></span>";
            ...
            if ($this->_page < $counter - 1)
                $pagination.= "<li class='page-item'><a  class='page-link' href='".$path."$this->_instance=$next"."$ext'><i class='fa fa-long-arrow-right' aria-hidden='true'></i></a></li>";
            else
                $pagination.= "<li class='page-item'><span class='disabled'><i class='fa fa-long-arrow-right' aria-hidden='true'></i></span></li>";
            $pagination.= "</ul> </nav>\n ";
        }
